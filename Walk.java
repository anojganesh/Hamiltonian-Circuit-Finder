...
public class Walk {
    ...
    /**
     * Creates a new empty Walk with room for a specified maximum number of
     * vertices.
     * 
     ...
     * <br>
     * Note that in closed walks the starting vertex will be counted twice.
     * 
     ...
     * @return True iff the vertex could be added, i.e maximum capacity was not
     *         exceeded
     *
     */
